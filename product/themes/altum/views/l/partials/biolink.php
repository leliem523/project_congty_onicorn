        ...
        <div class="row d-flex justify-content-center text-center">
            <div class="col-md-8 link-content <?= isset($_GET['preview']) ? 'container-disabled-simple' : null ?>">
                ...
                <header class="d-flex flex-column align-items-center" style="<?= $data->link->design->text_style ?>">
                    <img id="image" src="<?= $data->link->settings->image ? UPLOADS_FULL_URL . 'avatars/' . $data->link->settings->image : null ?>" alt="<?= language()->link->biolink->image_alt ?>" class="link-image" <?= !empty($data->link->settings->image) ? null : 'style="display: none;"' ?> />

                    <div class="d-flex flex-row align-items-center mt-4">
                        <h1 id="title" class="title-link"><?= $data->link->settings->title ?></h1>
